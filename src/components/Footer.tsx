          ...
          <div className="lg:col-span-8 text-center">
            ...
            <div className="newsletter max-w-xl mx-auto">
              {subscriptionStatus === "success" && (
                <div className="success bg-green-100 text-green-800 p-3 rounded mb-4">
                  已發送 Email 驗證信！請前往信箱驗證你的訂閱
                </div>
              )}
              {subscriptionStatus === "error" && (
                <div className="error bg-red-100 text-red-800 p-3 rounded mb-4">
                  訂閱失敗，請檢查 Email 是否輸入錯誤，或是聯繫 service@kucw.io 取得協助
                </div>
              )}
              {subscriptionStatus === "maintenance" && (
                <div className="maintenance bg-yellow-100 text-yellow-800 p-3 rounded mb-4">
                  電子報伺服器正在維護中，請稍後再試
                </div>
              )}
