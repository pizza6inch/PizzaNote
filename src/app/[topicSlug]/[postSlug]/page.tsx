...
export default async function Page({ params }: { params: Promise<{ topicSlug: string; postSlug: string }> }) {
  ...
  return (
    <MainLayout>
      <div className="md:block hidden fixed w-60 overflow-y-auto h-[90vh] py-10 px-5 bg-gray-100 dark:bg-gray-900 custom-scrollbar ">
      ...
      <div className=" grid grid-cols-12 pl-0 md:pl-60">
        <div className=" col-span-12 lg:col-span-9 py-10 px-10 space-y-5">
